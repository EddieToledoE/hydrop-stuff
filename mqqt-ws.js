...
const sensorTopic =
  "hydrop/668dee66cf7b5b0a30fb22a4/6699defcf167387f3335e144/sensor_data";
const pumpStatusTopic =
  "hydrop/668dee66cf7b5b0a30fb22a4/6699defcf167387f3335e144/pump_status";
const nutrientDispenserStatusTopic =
  "hydrop/668dee66cf7b5b0a30fb22a4/6699defcf167387f3335e144/nutrient_dispenser_status";
const pumpCommandTopic =
  "hydrop/668dee66cf7b5b0a30fb22a4/6699defcf167387f3335e144/pump/command";
const nutrientDispenserCommandTopic =
  "hydrop/668dee66cf7b5b0a30fb22a4/6699defcf167387f3335e144/nutrient_dispenser/command";
...
io.on("connection", (socket) => {
  ...
  socket.on("nutrient_dispenser_command", (command) => {
    console.log(
      `Comando de dispensador de nutrientes recibido: ${JSON.stringify(
        command
      )}`
    );
    client.publish(
      nutrientDispenserCommandTopic,
      JSON.stringify(command),
      (err) => {
        if (err) {
          console.error(
            "Error al publicar comando de dispensador de nutrientes:",
            err
          );
        } else {
          console.log(
            "Comando de dispensador de nutrientes publicado:",
            command
          );
        }
      }
...
client.on("connect", () => {
  ...
  client.subscribe(
    [sensorTopic, pumpStatusTopic, nutrientDispenserStatusTopic],
    (err) => {
      if (err) {
...
client.on("message", (topic, message) => {
  ...
  if (topic === sensorTopic) {
    ...
    io.to(stationId).emit(
      "nutrient_dispenser_status",
